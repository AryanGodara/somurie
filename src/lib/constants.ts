 ...
 */
export const APP_NAME: string = 'Somurie';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Creator Loans based on Creator Scores';
 ...
 */
export const APP_TAGS: string[] = ['creators', 'on-chain', 'creator-tokens', 'zora', 'farcaster', 'based', 'content', 'finance', 'infoFi'];
